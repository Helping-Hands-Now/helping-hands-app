      ...
      <div className="RichEditor-root">
        ...
        <div className={className} onClick={this.focus}>
          <Editor
            ...
            placeholder="Include pick-up instructions for your volunteers when participating in your Community Delivery Event."
            ref="editor"
            spellCheck={true}
          />
        </div>
...
const BLOCK_TYPES = [
  { label: <Icon name="list" />, style: "unordered-list-item" },
];
